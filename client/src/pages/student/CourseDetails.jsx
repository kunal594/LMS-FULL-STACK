...
const toggleSection = (index)=> {
  ...
  return courseData ? (
    ...
    md:px-36 px-8 md:pt-30 pt-20 text-left'>
      ...
      <div className='absolute top-0 w-full h-section-height -z-1
...
<p>{courseData.enrolledStudents.length}{courseData.enrolledStudents.length  > 1 ? 'students':'student'}</p>
        ...
        <p className='text-sm'> Course by <span className='text-blue-600 underline'>IIIT BHAGALPUR</span></p>
...
md: rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420]'>
